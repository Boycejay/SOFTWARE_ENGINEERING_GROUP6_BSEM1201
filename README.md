...
1. **Presentation Layer** — React Native mobile app (Android & iOS)
2. **Application Layer** — Node.js/Express backend handling business logic via RESTful API
3. **Data Layer** — Firebase Firestore, storing Users, Careers, Resources, Mentors, Opportunities, and Progress data
...
This project is licensed under the **MIT License** — see the `LICENSE` file for details. The MIT License was chosen for its compatibility with the Digital Public Goods Standard, enabling free use, modification, and distribution by schools, NGOs, and governments.
